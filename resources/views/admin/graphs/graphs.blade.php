...
@section('content')
    ...
    <div hidden id="MostPopularAnswersLabels">{{!empty($MostPopularAnswersLabels) ? $MostPopularAnswersLabels : ''}}</div>
    <div hidden id="MostPopularAnswersValues">{{!empty($MostPopularAnswersValues) ? $MostPopularAnswersValues : ''}}</div>
    <div hidden id="QuestionsOftenLeftLabels">{{!empty($QuestionsOftenLeftLabels) ? $QuestionsOftenLeftLabels : ''}}</div>
    <div hidden id="QuestionsOftenLeftValues">{{!empty($QuestionsOftenLeftValues) ? $QuestionsOftenLeftValues : ''}}</div>
    <div hidden id="MostPopularAnswersColorsData">{{!empty($MostPopularAnswersColorsData) ? $MostPopularAnswersColorsData : ''}}</div>
