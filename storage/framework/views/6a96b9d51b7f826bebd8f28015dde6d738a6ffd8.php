        ...
        <section class="content">
            ...
            <div class="form-group js-edit-questions-setting">
                ...
                <div class="form-group">
                    <form id="image" class="form-group uploadImage uploadImagePost" data-id="<?php echo e($id); ?>" method="POST" enctype="multipart/form-data">
                        <input data-id="<?php echo e($id); ?>" class="upload"
                               ...
                               multiple>
                        <input data-id="<?php echo e($id); ?>" type="submit">
                    </form>
                </div>
                <?php if(!empty($img)): ?>
                    <img style="width: 400px" src="<?php echo e(asset($img)); ?>" class="img-thumbnail">
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/selection/questionSelectionEdit.blade.php ENDPATH**/ ?>