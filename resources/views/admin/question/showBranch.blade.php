...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            @if(!empty($question))
                    <div class="accordion" id="accordion{{$question['id']}}" data-target="#collapse{{$question['id']}}" aria-expanded="true" aria-controls="collapse{{$question['id']}}" >
                        <div class="card">
                                ...
                                @foreach($question['answers'] as $answer)
                                    @if(trim($question['type']) === 'radio' || trim($question['type']) === 'checkbox')
                                        ...
                                        @if(trim($question['type']) === 'select')
                                            ...
                                            @endif
                                            <br>
                                            <button type="button" data-id="{{$question['id']}}" class="btn btn-primary add_answer">Добавить</button>
