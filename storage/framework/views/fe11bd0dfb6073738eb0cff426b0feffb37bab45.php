        ...
        <section class="content">
            ...
            <div class="form-group">
                <form id="addForm" class="form-group hostAdd" method="POST">
                    ...
                    <br>
                    <button type="submit" id="hostAdd" class="btn btn-primary">Отправить</button>
                </form>
            </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/host/addHost.blade.php ENDPATH**/ ?>