            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <a href="<?php echo e($question['prev']); ?>"><button class="btn btn-default prev">Назад</button></a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                            ...
                            <div class="card-header" id="heading<?php echo e($question['id']); ?>"  data-toggle="collapse" data-target="#collapse<?php echo e($question['id']); ?>" aria-expanded="true" aria-controls="collapse<?php echo e($question['id']); ?>">
                                <h5 class="mb-0 js-edit-question_title">
                                    ...
                                    <button class="btn btn-link" type="button">
                                        <input type="text" data-id="<?php echo e($question['id']); ?>" data-name="title" class="form-control inp"  value="<?php echo e($question['title']); ?>"> <a href="<?php echo e($edit . $question['id'] . '/edit'); ?>"><button type="button" class="btn btn-secondary edit_question">Редактировать</button></a><?php if(!empty($question['branch_id'])): ?>  <a href="<?php echo e(SITE . '/admin/host/' . $question['host_id'] . '/question/' . $question['branch_id']); ?>"><button type="button" class="btn btn-secondary show_branch">Посмотреть ветку</button></a> <button type="button" data-id="<?php echo e($question['branch_id']); ?>" class="btn btn-danger delete_branch_question">Удалить ветку</button> <?php else: ?>  <?php if(trim(strtolower($question['type'] !== 'radio'))): ?>  <a><button data-id="<?php echo e($question['id']); ?>" data-selection-id="<?php echo e(!empty($host['selection_id']) ? $host['selection_id'] : ''); ?>" data-hostID="<?php echo e($hostID); ?>" type="button" class="btn btn-secondary add_branch_question">Добавить ветку</button></a> <?php endif; ?> <?php endif; ?>
                                    </button>
                                </h5>
                            </div>
                                ...
                                <?php $__currentLoopData = $question['answers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(trim($question['type']) === 'radio' || trim($question['type']) === 'checkbox'): ?>
                                        ...
                                        <?php if(trim($question['type']) === 'select'): ?>
                                            ...
                                            <?php endif; ?>
                                            <br>
                                            <button type="button" data-id="<?php echo e($question['id']); ?>" class="btn btn-primary add_answer">Добавить</button>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\quiz-service\resources\views/admin/question/showBranch.blade.php ENDPATH**/ ?>